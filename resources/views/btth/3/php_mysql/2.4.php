    ...
    <div style='overflow-x: auto;'>
        <table>
            <tr style='background:pink;'>
                <th colspan='6'><p class='center'>THÔNG TIN SỮA</p></th>
            </tr>
        ...
        <?php
            ...
            $mysql="SELECT `sua`.`Ten_sua`, `sua`.`Trong_luong`, `sua`.`Don_gia`, `hang_sua`.`Ten_hang_sua`, `loai_sua`.`Ten_loai` 
            ...
            if($numRows!==0)
            {
                ...
                while($rows=mysqli_fetch_array($result))
                {
                    ...
                    echo "<tr>";
                        ...
                        echo "<td align='center'>{$rows['Ten_sua']}</td>";
                        echo "<td align='center'>{$rows['Ten_hang_sua']}</td>";
                        echo "<td align='center'>{$rows['Ten_loai']}</td>";
                        echo "<td align='center'>{$rows['Trong_luong']} gram</td>";
                        echo "<td align='center'>{$rows['Don_gia'] } VNĐ</td>";
                    echo "</tr>";
                }
                echo"</table> </div>";
                $requery = mysqli_query($conn, 'select * from sua');
                $numRows = mysqli_num_rows($requery);
