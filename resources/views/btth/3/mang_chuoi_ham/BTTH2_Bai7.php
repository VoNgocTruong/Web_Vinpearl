...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $hinh = $mang_hinh[$chi];
        $img = "<img src='http://localhost/php/BTTH_chinh/img/$hinh' width='150px' height='150px'>";
    }
?>
    <form action="" method="post">
        <table align="center" bgcolor="#C4ECFD">
            <tr>
                <td align="center" bgcolor="#2D64C3" style="color:#FFFFFF" colspan="2"><h1>TÍNH NĂM ÂM LỊCH</h1></td>
            </tr>
            <tr>
                <td>
                        Năm dương lịch
