...
<div class="text-center flex justify-center items-center">
  <form action="{{route('login')}}" method="POST">
    ...
    <div class="mt-5">
      <input type="password" name="matKhau" required class="px-3 w-full h-10 border border-black rounded-lg" placeholder="Password">
    </div>
    ...
    <div class="mt-5">
      You didn't have any account? <a class='text-blue-500' href="{{route('show-registration')}}">Register</a>
    </div>
    <div class="mt-5">
