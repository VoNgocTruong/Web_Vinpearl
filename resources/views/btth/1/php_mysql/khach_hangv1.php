    ...
    <table border="1" style="width: 100%;">
        ...
        <?php $count = 0; foreach ($result as $each): ?>
            <tr style="<?php echo ($count % 2 == 0) ? 'background-color:#FEE0C1' : 'background-color:white'; ?>; color:#725350">
                ...
                <td align="center">
                    <?php echo $each['Phai'] == 0 ? '<img width="50px" height="50px" src="/hinhBTTH/1/img/gender/male.png" alt="Nam">' : '<img width="50px" height="50px" src="/hinhBTTH/1/img/gender/female.png" alt="Nữ">' ; ?>
                </td>
                <td>
