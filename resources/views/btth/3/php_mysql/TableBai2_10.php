    ...
    <?php
        ...
        if( mysqli_num_rows ( $result ) !=0){
            while ( $row = mysqli_fetch_array($result)) {
                $imageDirectory = "../hinhBTTH/img/Hinh_sua/"; // Update the directory path
...
<p align="center">
<?php?>
    <a href="Bai2_10.php?p=<?php echo 1;?>"><<</a>
    <a href="Bai2_10.php?p=<?php if($p>1) echo $p-1; else echo $p;?>"><</a>
<?php?>
    <?php for ($i=1; $i <= $tst; $i++) {?>
    <a href="Bai2_10.php?p=<?php echo $i;?>"><?php echo $i;?></a>
<?php }?>
<?php?>
    <a href="Bai2_10.php?p=<?php if($p>=1 && $p<$tst) echo $p+1; else echo $tst;?>">></a>
    <a href="Bai2_10.php?p=<?php echo $tst;?>">>></a>
<?php?>
</p>