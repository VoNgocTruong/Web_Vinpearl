    ...
    <form action="bt8.php" method="post">
        <table align="center">
            ...
            <tr>
                <td>Gender:</td>
                <td>
                    <input type="radio" name="gender" id="x" value="Nam" <?php if(isset($_POST['gender']) == "Nam") echo 'checked';?>>
                    <label>Nam</label>
                    <input type="radio" name="gender" id="x" value="Nữ" <?php if(isset($_POST['gender']) == "Nữ") echo 'checked';?>>
                    <label>Nữ</label>
                </td>
            </tr>
            <tr>
